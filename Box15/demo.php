...
function runBasicDemo() {
    ...
    $registry->register('greeting', function($params = []) {
    ...
    $registry->register('html_page', function($params = []) {
    ...
    echo "greeting(['name' => 'Alice']): " . $greeting(['name' => 'Alice']) . "\n\n";
    ...
    echo "  get('nonexistent'): " . ($missing === null ? 'null ✓' : 'unexpected value') . "\n";
    echo "  has('greeting'): " . ($registry->has('greeting') ? 'true ✓' : 'false') . "\n";
    echo "  has('nonexistent'): " . ($registry->has('nonexistent') ? 'true' : 'false ✓') . "\n\n";
